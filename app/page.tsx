    ...
    <div className="min-h-screen bg-dark-bg">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            <h1 className="text-5xl font-bold font-inter text-dark-text mb-8">
              I'm <span className="text-highlight-red">Constanze</span>
            </h1>
            
            <div className="space-y-6">
              <div className="bg-dark-surface p-6 rounded-lg">
                <h3 className="text-xl font-semibold font-inter text-dark-text mb-3">
                  Veterinary Medicine & PhD
                </h3>
                <p className="text-dark-text-secondary font-inter leading-relaxed">
          ...
          <div className="space-y-8">
            <div className="bg-note-yellow p-8 rounded-lg text-black">
              <blockquote className="text-2xl font-light font-inter italic leading-relaxed mb-4">
              ...
              <cite className="text-sm font-medium font-inter">
                — Constanze
              </cite>
            </div>

            <div className="space-y-6">
              <h3 className="text-2xl font-semibold font-inter text-dark-text">
                Building in Public
              </h3>
              <p className="text-lg text-dark-text-secondary font-inter leading-relaxed">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-4xl font-bold font-inter text-dark-text">
            Latest Blog Posts
          </h2>
          <Link
            href="/blog"
            className="px-6 py-3 border-2 border-dark-text text-dark-text font-inter font-semibold hover:bg-dark-text hover:text-dark-bg transition-colors"
          >
            View All Posts →
          </Link>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {blogPosts.slice(0, 3).map((post) => (
            ...
            >
              ...
              <div className="p-4">
                <h3 className="text-lg font-semibold font-inter text-dark-text mb-2 group-hover:text-dark-accent transition-colors line-clamp-2">
                  {post.title}
                </h3>
                <p className="text-dark-text-secondary font-inter text-sm leading-relaxed line-clamp-2">
                  {post.excerpt}
                </p>
              </div>
            </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {gardenNotes.slice(0, 4).map((note, index) => {
            ...
            return (
              ...
              >
                <h3 className="text-sm font-semibold font-inter mb-2 line-clamp-2">
                  {note.title}
                </h3>
                <p className="text-xs font-inter line-clamp-3 leading-relaxed">
                  {note.excerpt}
                </p>
              </Link>
            );
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-3xl font-bold font-inter text-dark-text">
                Resources
              </h2>
              <Link
                href="/resources"
                className="text-dark-accent font-inter font-semibold hover:underline"
              >
                View All →
              </Link>
            </div>
            <div className="bg-dark-surface p-6 rounded-lg">
              ...
              <p className="text-dark-text-secondary font-inter leading-relaxed mb-4">
