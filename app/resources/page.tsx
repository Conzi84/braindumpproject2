      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-note-orange p-8 rounded-lg text-black">
            ...
            <div className="bg-note-pink p-8 rounded-lg text-black">
              <h3 className="text-2xl font-bold font-montserrat mb-4">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-dark-surface p-6 rounded-lg">
              ...
              <p className="text-dark-text-secondary font-open-sans leading-relaxed">
