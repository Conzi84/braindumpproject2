    ...
    <div className="min-h-screen bg-dark-bg">
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold font-montserrat text-dark-text mb-8">
            Current Role: AI & Risk Management
          </h2>
          <div className="bg-dark-surface p-8 rounded-lg mb-8">
            <h3 className="text-2xl font-bold font-montserrat text-dark-text mb-4">
              Managing AI and Risk at Local Company
            </h3>
            <p className="text-lg text-dark-text-secondary font-open-sans leading-relaxed mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="text-lg font-semibold font-montserrat text-dark-text mb-3">
          ...
          <div className="bg-dark-surface p-8 rounded-lg">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-dark-text-secondary font-open-sans leading-relaxed mb-4">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-dark-surface p-6 rounded-lg">
              <h3 className="text-xl font-bold font-montserrat text-dark-text mb-3">
                AI Risk Framework
              </h3>
              <p className="text-dark-text-secondary font-open-sans leading-relaxed mb-4">
              ...
              <span className="text-sm text-dark-accent font-semibold">Current Project</span>
            </div>
