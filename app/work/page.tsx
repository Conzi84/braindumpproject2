      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-note-green dark:bg-note-green-dark p-8 rounded-lg text-black dark:text-white">
            ...
            <div className="bg-note-blue dark:bg-note-blue-dark p-8 rounded-lg text-black dark:text-white">
              <h3 className="text-2xl font-bold font-montserrat mb-4">
